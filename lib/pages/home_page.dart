import 'package:chat/Contact/cse.dart';
import 'package:chat/helper/helper_function.dart';
import 'package:chat/pages/auth/login_page.dart';
import 'package:chat/pages/auth/profile_page.dart';
import 'package:chat/pages/auth/request.dart';
import 'package:chat/pages/auth/search_page.dart';
      ...
      drawer: Drawer(
        child: ListView(
          ...
          children: <Widget> [
            ...
            ListTile(
              onTap: (){
                Navigator.of(context).pushNamed(Requests.routeName);
              },
              contentPadding: const EdgeInsets.symmetric(horizontal: 20, vertical: 5),
